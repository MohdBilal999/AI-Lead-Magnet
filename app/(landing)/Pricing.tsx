...
const PricingFeature = ({
  ...
  <div className="flex items-center">
    <FaCheck
      className={`mr-2 ${included ? "text-purple-500" : "text-gray-300"}`}
    />
    ...
    <section className="py-20 bg-gradient-to-br from-purple-500 via-pink-500 to-red-500">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 h-full">
            ...
            <CardContent className="pt-4">
              <div className="space-y-4">
                <PricingFeature
                  included={true}
                  text="Create up to 2 AI Lead Magnets"
                />
                <PricingFeature included={true} text="Basic lead capture" />
                <PricingFeature
                  included={false}
                  text="Unlimited lead magnets"
                />
          ...
          {/* Pro Plan */}
          <Card className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white dark:bg-gray-950 h-full">
            ...
            <CardContent className="pt-4">
              <div className="space-y-4">
                <PricingFeature
                  included={true}
                  text="Unlimited AI Lead Magnets"
                />
                <PricingFeature
                  included={true}
                  text="Convert leads into customers"
                />
